<%@ Page Title="" Language="C#" MasterPageFile="~/admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="opretVare.aspx.cs" Inherits="admin_opretVare" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
    ...
    <div class="billede_right">
        ...
        <br />
        <asp:Label ID="Label1" CssClass="fed" Text="Billednavn:" runat="server"></asp:Label>
